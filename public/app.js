...
function showPage(name) {
  ...
  if (name === 'cart')     { renderCart(); closeCartBanner(); }
...
function addToCart(productId) {
  ...
  saveState(); updateCartCount(); updateCartBanner();
...
function createCartBanner() {
  ...
  div.innerHTML =
    ...
    '<div style="display:flex;justify-content:space-between;align-items:center;padding:0 4px">' +
      '<span style="color:#8a7a62;font-size:11px;font-family:\'Jost\',sans-serif;letter-spacing:1px;text-transform:uppercase">'+__('Total')+'</span>' +
      '<span id="cart-banner-total" style="color:#c9a96e;font-size:17px;font-weight:bold;font-family:\'Cormorant Garamond\',serif"></span>' +
    '</div>';
...
function changeQty(id, delta) {
  ...
  updateCartCount(); renderCart(); saveState(); updateCartBanner();
}
